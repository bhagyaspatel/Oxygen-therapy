...
class DonePatientAdapter (private var list : MutableList<PatientAndHospital>, private val listener : (Boolean, String) -> Unit)
: RecyclerView.Adapter<DonePatientAdapter.ViewHolder>() {

    val TAG = "DonePatient"

    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val patientName = itemView.findViewById<TextView>(R.id.doneName)
        val age = itemView.findViewById<TextView>(R.id.doneAge)
        val sex = itemView.findViewById<TextView>(R.id.doneSex)
        val area = itemView.findViewById<TextView>(R.id.doneArea)
        val hospitalNum = itemView.findViewById<TextView>(R.id.doneHospitalNum)
        val date = itemView.findViewById<TextView>(R.id.doneDate)

        val deleteBtn = itemView.findViewById<ImageButton>(R.id.doneDeleteBtn)
...
//                submitList(newList)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemLayout = LayoutInflater.from (parent.context)
            .inflate(R.layout.done_patient_view, parent, false)
